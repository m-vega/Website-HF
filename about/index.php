...
<div id="home1" class="container-fluid">
    <div class="container " id="content">
                           <div class="row" >
            <div class="col-md-6">
               <h1 class="page-header">About Heirloom Farms</h1>
                <p>Heirloom Farms is a family driven company.</p>
                
                <p>Founded in 1979, our company began operations with two brothers who were trying to compete and be one of the first in the region to innovate in terms of production and new varieties introduction.</p>

                <p>As the younger members of the family started to incorporate, new ideas and strategies emerged in order to help Heirloom Farms grow in what it represents today in the region; a company that believes that success depends on continuous and absolute dedication. </p>

                <p>This philosophy drives us and encourages us to create innovative products of the highest quality to serve the important needs of our customers. </p>
            </div>
        </div>
        <!-- /.row -->
